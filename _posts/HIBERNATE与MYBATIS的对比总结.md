---
title: HIBERNATE与MYBATIS的对比总结
date: 
categories: [Hibernate,MyBatis]
tags: HIBERNATE与MYBATIS的对比总结
---
转，我是一名java开发人员，hibernate以及mybatis都有过学习，在java面试中也被提及问道过，在项目实践中也应用过，现在对hibernate和mybatis做一下对比，便于大家更好的理解和学习，使自己在做项目中更加得心应手。
